...
class KDClipLoss(nn.Module):
    ...
    def __init__(
        ...
        #learnable logit scale for new_ce_loss
    ...
    def forward(self, image_features, text_features, logit_scale, \
        t_image_features, t_text_features, t_logit_scale, current_step):
        device = image_features.device
        ...
        if self.world_size > 1:
            ...
            if self.local_loss:
                ...
                st_logits_per_text = self.text_logit_scale * normalized_text_features @ t_all_text_features.T
            ...
            tist_logits = self.cross_logit_scale * t_all_image_features @ normalized_text_features.T
            ttsi_logits = self.cross_logit_scale * t_all_text_features @ normalized_image_features.T
            sitt_logits = self.cross_logit_scale * normalized_image_features @ t_all_text_features.T
            stti_logits = self.cross_logit_scale * normalized_text_features @ t_all_image_features.T
